...
diffusivity_preexponential_factor = '${units 0.20e-6 m^2/s -> mm^2/day}' #https://www.sandia.gov/app/uploads/sites/158/2021/12/1500TechRef_ferriticSS.pdf
...
# diffusivity_H_in_steel = '${units 1e-2 mm^2/day}'
# Solubility in Steel
